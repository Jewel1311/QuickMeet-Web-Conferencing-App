...
function MeetControls({toggleChat, showChat, closeCall}) {
  ...
  return (
    <div className='controls d-flex justify-content-center align-items-center'>
      ...
      <button className='border-none btn btn-info rounded-circle mx-2'><i className="fa-solid fa-microphone"></i></button>
